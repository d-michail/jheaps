...
public class CostlessMeldPairingHeapTest extends AbstractAddressableHeapTest {
	...
	public void testMeld() throws IOException, ClassNotFoundException {
		...
		CostlessMeldPairingHeap<Integer, Void> h1 = new CostlessMeldPairingHeap<Integer, Void>();
		CostlessMeldPairingHeap<Integer, Void> h2 = new CostlessMeldPairingHeap<Integer, Void>();
	...
	public void testMeldWrong() throws IOException, ClassNotFoundException {
		...
		CostlessMeldPairingHeap<Integer, Void> h1 = new CostlessMeldPairingHeap<Integer, Void>();
		CostlessMeldPairingHeap<Integer, Void> h2 = new CostlessMeldPairingHeap<Integer, Void>(comparator);
