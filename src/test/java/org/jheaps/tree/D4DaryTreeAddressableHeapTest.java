...
public class D4DaryTreeAddressableHeapTest extends AbstractAddressableHeapTest {
	...
	protected AddressableHeap<Integer, Void> createHeap() {
		return new DaryTreeAddressableHeap<Integer, Void>(4);
	}

	@Override
	protected AddressableHeap<Integer, Void> createHeap(Comparator<Integer> comparator) {
		return new DaryTreeAddressableHeap<Integer, Void>(4, comparator);
	}

	@Override
	protected AddressableHeap<Integer, String> createHeapWithStringValues() {
		return new DaryTreeAddressableHeap<Integer, String>(4);
	}
}
