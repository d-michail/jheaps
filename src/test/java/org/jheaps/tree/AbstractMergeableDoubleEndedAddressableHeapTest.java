...
public abstract class AbstractMergeableDoubleEndedAddressableHeapTest {
    ...
    public void testMeld2() {
        ...
        MergeableDoubleEndedAddressableHeap<Integer, String> c = createHeap();
        c.insert(18);
        c.insert(19);
        c.insert(20);
    ...
    public void testCascadingMelds() {
        ...
        MergeableDoubleEndedAddressableHeap<Integer, String> d = createHeap();
        d.insert(22);
        d.insert(23);
        d.insert(24);
        d.insert(25);

        MergeableDoubleEndedAddressableHeap<Integer, String> e = createHeap();
        e.insert(26);
        e.insert(27);
    ...
    public void testMeldGeneric() {
        MergeableDoubleEndedAddressableHeap<Integer, String> h1 = createHeap();

        for (int i = 0; i < SIZE; i++) {
            h1.insert(2 * i);
        }

        MergeableDoubleEndedAddressableHeap<Integer, String> h2 = createHeap();
        for (int i = 0; i < SIZE; i++) {
            h2.insert(2 * i + 1);
        }
    ...
    public void testMeldWithComparator() {
        MergeableDoubleEndedAddressableHeap<Integer, String> h1 = createHeap(comparator);
        MergeableDoubleEndedAddressableHeap<Integer, String> h2 = createHeap(comparator);
    ...
    public void testMeldBadComparator() {
        MergeableDoubleEndedAddressableHeap<Integer, String> h1 = createHeap(comparator);
        MergeableDoubleEndedAddressableHeap<Integer, String> h2 = createHeap(new Comparator<Integer>() {
            @Override
            public int compare(Integer o1, Integer o2) {
                return (int) (o1 - o2);
            }
    ...
    public void testMeldBadComparator1() {
        MergeableDoubleEndedAddressableHeap<Integer, String> h1 = createHeap(comparator);
        MergeableDoubleEndedAddressableHeap<Integer, String> h2 = createHeap(null);
        try {
            h1.meld(h2);
            fail("No!");
        } catch (IllegalArgumentException e) {
