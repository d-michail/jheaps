 ...
 * @see Serializable
 */
public class DaryHeap<K> extends AbstractDaryImplicitHeap<K> implements Serializable {
	 ...
	 * {@link DaryHeap#DEFAULT_HEAP_CAPACITY} and adjusts automatically based on
