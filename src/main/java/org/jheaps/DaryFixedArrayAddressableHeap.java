...
/**
 * An array based d-ary addressable heap with a maximum number of elements. The
...
public class DaryFixedArrayAddressableHeap<K, V> extends AbstractDaryArrayAddressableHeap<K, V>
    ...
    public static <K, V> DaryFixedArrayAddressableHeap<K, V> heapify(int d, K[] keys, V[] values,
        ...
        DaryFixedArrayAddressableHeap<K, V> h = new DaryFixedArrayAddressableHeap<K, V>(d, comparator, keys.length);
