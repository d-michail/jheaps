...
public class BinaryFixedArrayWeakHeap<K> extends AbstractBinaryArrayWeakHeap<K> implements Serializable {
     ...
     */
    public BinaryFixedArrayWeakHeap(int capacity) {
        super(null, capacity);
    }
     ...
     *            the initial heap capacity
     */
    public BinaryFixedArrayWeakHeap(Comparator<? super K> comparator, int capacity) {
     ...
     */
    @LinearTime
    public static <K> BinaryFixedArrayWeakHeap<K> heapify(K[] array) {
        if (array == null) {
            throw new IllegalArgumentException("Array cannot be null");
        }
        if (array.length == 0) {
            return new BinaryFixedArrayWeakHeap<K>(0);
        }

        BinaryFixedArrayWeakHeap<K> h = new BinaryFixedArrayWeakHeap<K>(array.length);
     ...
     */
    @LinearTime
    public static <K> BinaryFixedArrayWeakHeap<K> heapify(K[] array, Comparator<? super K> comparator) {
        if (array == null) {
            throw new IllegalArgumentException("Array cannot be null");
        }
        if (array.length == 0) {
            return new BinaryFixedArrayWeakHeap<K>(comparator, 0);
        }

        BinaryFixedArrayWeakHeap<K> h = new BinaryFixedArrayWeakHeap<K>(comparator, array.length);
